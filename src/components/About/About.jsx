    ...
    return (
        <div className='gray-gradient lg:my-40 lg:px-64 flex justify-between text-center lg:text-left px-10'>
            ...
            <div className='w-full lg:w-[48%] flex flex-col justify-center items-center gap-10 lg:gap-6'>
                ...
                <p className='text-sm subheading-typo lg:text-base'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. t has survived not only five centuries.</p>
